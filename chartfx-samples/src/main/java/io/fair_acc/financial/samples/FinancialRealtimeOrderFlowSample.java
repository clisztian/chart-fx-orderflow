 ...
 * @author afischer
 */
public class FinancialRealtimeOrderFlowSample extends AbstractOrderFlowFinancialApplication {
    /**
    ...
    protected Scene prepareScene() {
        ...
        System.out.println(ohlcvDataSet.getClass().getName());
        if (ohlcvDataSet instanceof TickOhlcvReplayDataSet) {
            TickOhlcvReplayDataSet replayDataSet = ((TickOhlcvReplayDataSet) ohlcvDataSet);
            ...
            System.out.println("Trade plan: " + tradePlan);
        }
